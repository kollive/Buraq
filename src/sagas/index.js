...
export default function* rootSaga () {
  try {
    ...
    yield all( [
        ...
        takeLatest([ManageStaffTypes.INSERT_REQUEST,ManageStaffTypes.FETCH_STAFF_REQUEST,ManageStaffTypes.UPDATE_STAFF_REQUEST], ManageStaffSaga.handleRequest),
        takeLatest([StaffListTypes.FETCH_REQUEST,StaffListTypes.DELETE_REQUEST,StaffListTypes.FETCH_STAFF_RESOURCE_DETAILS], StaffListSaga.handleRequest),        
